    ...
    <section id="how-it-works" className="relative scroll-mt-24 py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <SectionHeading
          ...
          title={
            <>
              A four-stage <span className="text-cyan">prototype workflow</span>
            </>
          }
          description="The demo moves from simulated bay states to a transparent recommendation without claiming live camera input or trained-model performance."
        />
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          {[
            { k: "SIM", v: "Input data", d: "Browser-based parking states" },
            { k: "5", v: "Ranking factors", d: "Availability, access, distance, and bay type" },
            { k: "LIVE", v: "Demo loop", d: "Adjustable simulation speed" },
          ].map((s) => (
