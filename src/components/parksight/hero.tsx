...
const HIGHLIGHTS = [
  { icon: Cctv, label: "Sample feed overlay" },
  { icon: Cpu, label: "Simulated bay states" },
  { icon: Sparkles, label: "Prototype ranking" },
]
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-electric/30 bg-electric/5 px-4 py-1.5 text-xs font-medium tracking-wide text-electric animate-fade-up">
            ...
            AI Immersion Project · Prototype
          </span>
          ...
          >
             ParkSight AI demonstrates how simulated parking states can surface availability
             and recommend a suitable space — turning a complex concept into a guided experience.
          </p>
